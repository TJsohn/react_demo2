...
const AddBookForm = ({onAddBook}) => {
    ...
    const handleChange = (e) => {
        ...
        setFormData((prev) => ({...prev, [name]: value})); // or [e.target.name] : e.target.value without const below
    };
    ...
    return (
      <>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="number" placeholder="Price" value={formData.price} onChange={handleChange} name="price"/>
